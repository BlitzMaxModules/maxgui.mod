...
ModuleInfo "History: Added support for PANEL_RAISED style flag."
ModuleInfo "History: Implemented grable's OnCommand() tweak."
ModuleInfo "History: Fixed ActiveGadget() returning Null when HTMLViews have focus."
ModuleInfo "History: 0.71 Release"
ModuleInfo "History: Cleaned up TWindowsFont so that RequestFont() should now return expected results."
ModuleInfo "History: 0.70 Release"
ModuleInfo "History: Fixed tabber icons not being set."
ModuleInfo "History: 0.69b Release"
ModuleInfo "History: Windows are now only revealed when they are correctly positioned, to avoid momentary flicker."
ModuleInfo "History: 0.69 Release"
ModuleInfo "History: Task-bar area should now no longer be included when querying workspace dimensions."
ModuleInfo "History: Added LookupColor() method to TWindowsGUIDriver."
ModuleInfo "History: 0.68b Release"
ModuleInfo "History: Committed ListBox Slider glitch workaround for Grisu."
ModuleInfo "History: 0.68 Release"
ModuleInfo "History: Suppressed hotkeys with modifiers from being passed to graphics contexts/active panels."
ModuleInfo "History: Combined BitmapFromPixmap24 and BitmapFromPixmap32 into one function."
ModuleInfo "History: Swapped out String-based hWnd TMap for more efficient TIntWrapper equivalent."
ModuleInfo "History: Fixed HtmlViewCurrentUrl() and associated memory leak(s)."
ModuleInfo "History: 0.67 Release"
ModuleInfo "History: Added hack to stop scroll-bars re-enabling when range is changed."
ModuleInfo "History: Silenced system beep with 'Alt' hotkeys."
ModuleInfo "History: 0.66 Release"
ModuleInfo "History: Fixed a textarea redraw problem, and added hack to fix cursor sometimes getting stuck on 'busy' when highlighting."
ModuleInfo "History: Improved handling of 'Alt' and firing of events when keys are hotkeys."
ModuleInfo "History: Optimized brush transparency code by caching brushes."
ModuleInfo "History: HotKey fix for modifiers."
ModuleInfo "History: Disabling a panel should now grey out all of its children."
ModuleInfo "History: State() is now no longer recursive."
ModuleInfo "History: Toolbars now push down the client area of the parent window."
ModuleInfo "History: Tidying up of some of the window sizing code."
ModuleInfo "History: Attempt to fix some drawing slow-downs/bugs."
ModuleInfo "History: 0.65 Release"
ModuleInfo "History: Made use of TGadget's style field instead of additional _style."
ModuleInfo "History: Fixed RequestFont() bug - thanks klepto2!"
ModuleInfo "History: Fixed toolbar ListItemState() and loss of state on ModifyGadgetItem."
ModuleInfo "History: Fixed recursive PopupWindowMenu event extra bug when using hooks."
ModuleInfo "History: Standard checkboxes/radio-buttons now support text colors, but do so by losing theming."
ModuleInfo "History: Fixed hotkey focus issues for window menus."
ModuleInfo "History: Added recursive owner.source handling to SystemEmitOSEvent."
ModuleInfo "History: 0.64 Release"
ModuleInfo "History: SelectTreeViewNode(TreeViewRoot(treeView)) now deselects the currently selected node."
ModuleInfo "History: RichEdit 4.1 should now be used when available."
ModuleInfo "History: Controls will now only be double-buffered on Windows Vista (or higher) by default."
ModuleInfo "History: 0.63 Release"
ModuleInfo "History: Graphics contexts are now closed automatically when a canvas is freed."
ModuleInfo "History: Resizable windows with a maximum size set can no longer be maximized."
ModuleInfo "History: 0.62 Release"
ModuleInfo "History: Changed handling of '-1' icons in listboxes and toolbars."
ModuleInfo "History: 0.61 Release"
ModuleInfo "History: Added workaround for flipped vertical trackbar."
ModuleInfo "History: Corrected insert node index behaviour."
ModuleInfo "History: Fixed GetText() on tree-view nodes."
ModuleInfo "History: Tweaked SetIconStrip() for list based gadgets."
ModuleInfo "History: 0.60 Release"
ModuleInfo "History: Fixed memory exception when freeing a treeview node accidentally a second time."
ModuleInfo "History: Fixed htmlview GetText implementation."
ModuleInfo "History: 0.59 Release"
ModuleInfo "History: Maintenance release."
ModuleInfo "History: 0.58 Release"
ModuleInfo "History: Added calls so that the client position is updated when tab items are set."
ModuleInfo "History: 0.57 Release"
ModuleInfo "History: Added new iconless window class for child windows."
ModuleInfo "History: Swapped slider API messages for their 32-bit signed counterparts."
ModuleInfo "History: 0.56 Release"
ModuleInfo "History: Tweaked the appearance of LABEL_SEPARATOR."
ModuleInfo "History: Silenced EVENT_GADGETSELECT event emitted when a selected list item was removed."
ModuleInfo "History: Fixed mouse capture handling (again!) when holding more than one mouse button down."
ModuleInfo "History: 0.55 Release"
ModuleInfo "History: Added EVENT_GADGETMENU for tabbers."
ModuleInfo "History: Added CharX() and CharY() methods to TWindowsTextArea."
ModuleInfo "History: Fixed UnlockText() selection error that was causing erratic highlighting when block-indenting/outdenting code in the IDE."
ModuleInfo "History: Fixed SetGadgetPixmap() and SetGadgetText() bug."
ModuleInfo "History: Added GadgetCut(), GadgetCopy() and GadgetPaste() to textfields and editable comboboxes."
ModuleInfo "History: Added preliminary support for text and background colours on standard push buttons (no icon/pixmap support atm)."
ModuleInfo "History: 0.54 Release"
ModuleInfo "History: Removed the DebugLog calls."
ModuleInfo "History: Fixed Windows 9X infinite loops from client hwnd CallWindowProc in TWindowsGUIDriver.ClassWndProc."
ModuleInfo "History: 0.53 Release"
ModuleInfo "History: Fixed missing event from tabber when removing items."
ModuleInfo "History: Fixed definition clash with mshtmlview.cpp and MaxGUI.Win32MaxGUI's win32htmlview.cpp."
ModuleInfo "History: 0.52 Release"
ModuleInfo "History: Added LockText() and UnlockText() selection code."
ModuleInfo "History: Fixed font-size rounding error."
ModuleInfo "History: Fixed more window hiding bugs with windows whose children have focus."
ModuleInfo "History: Fixed toolbar accepting files as drop-target without window having WINDOW_ACCEPTFILES flag."
ModuleInfo "History: Fixed SetGadgetSensitivity() mouse-click events where possible by implementing new system mouse hook."
ModuleInfo "History: Further improved the reliability of TWindowsFont.GetDefault()."
ModuleInfo "History: Added new BUTTON_PUSH support for radio/checkboxes."
ModuleInfo "History: Added symbol based font loading (e.g. Wingdings) and fixed tiny font memory leak."
ModuleInfo "History: Added LibraryFont() method to TWindowsGUIDriver."
ModuleInfo "History: Implemented quick-hack so that editable comboboxes are redrawn after the window has been moved."
ModuleInfo "History: 0.51 Release"
ModuleInfo "History: Fixed the TWindowsHTMLView x/y-coordinate bug when not positioned at 0,0."
ModuleInfo "History: 0.50 Release"
ModuleInfo "History: Added new Class() method to return a gadget's class for the new GadgetClass() function."
ModuleInfo "History: Plugged memory leaks from GetDC."
ModuleInfo "History: Events should now be silenced if generated while attemping to free a treeview node."
ModuleInfo "History: 0.49 Release"
ModuleInfo "History: Fixed button tooltips disappearing permanently on Windows XP."
ModuleInfo "History: Fixed resetting gadget tooltips using SetGadgetTooltip."
ModuleInfo "History: Gadgets should now respond to GetSensitivity() and SetSensitivity() methods."
ModuleInfo "History: 0.48 Release"
ModuleInfo "History: Removed redundant ATL code from Skid's original BlitzMax-based HTMLView."
ModuleInfo "History: Added hack to address XP's resistance to hide text when BS_BITMAP is set."
ModuleInfo "History: The drawing context is now saved/restored whenever the background is painted to fix font problems."
ModuleInfo "History: Fixed separators - they can now be horizontal or vertical but restricted to 4 pixels thick."
ModuleInfo "History: Reduced flickering when *moving* a window with an editable combobox on it."
ModuleInfo "History: Fixed conflicting WS_EX_COMPOSITED and WS_EX_LAYERED flags on windows."
ModuleInfo "History: Fixed slider redraw problems on XP."
ModuleInfo "History: Fixed treeview memory leak by releasing integer memory handle."
ModuleInfo "History: Removed WS_EX_TRANSPARENT from group panels as it was causing strange drawing problems on XP."
ModuleInfo "History: Fixed ComboBox GetText() method so text is retrieved even if it isn't COMBOBOX_EDITABLE."
ModuleInfo "History: Added support for toggle buttons on toolbars."
ModuleInfo "History: More events should now be suppressed if triggered programatically by using Sensitize()/Desensitize() pairs."
ModuleInfo "History: 0.47 Release"
ModuleInfo "History: Fixed XP tab-background redraw problem."
ModuleInfo "History: Added preliminary SetGadgetTooltip() support for non-item based gadgets."
ModuleInfo "History: Added SetPixmap() support for push-buttons and menus."
ModuleInfo "History: Added fix to prevent hot-key events being generated when the source gadget is disabled."
ModuleInfo "History: Added fix to remove hotkey before calling SetGadgetHotKey()."
ModuleInfo "History: Introduced possible fix for requester parenting bug."
ModuleInfo "History: Plugged a tiny memory leak when freeing gadgets."
ModuleInfo "History: 0.46 Release"
ModuleInfo "History: Fixed text-field text colour."
ModuleInfo "History: Added the WS_EX_TRANSPARENT and WS_CLIPCHILDREN flags to group-boxes to speed-up redraw."
ModuleInfo "History: Implemented BeginDeferWindowsPos(), DeferWindowPos(), and EndWindowPos()."
ModuleInfo "History: Fixed DC memory leaks as a result of incorrectly using ReleaseDC() instead of DeleteDC()."
ModuleInfo "History: Improved client dimensions methods so that they work independent of resize stage."
ModuleInfo "History: 0.45 Release"
ModuleInfo "History: Moved most externs and imports to a separate file 'winimports.bmx'."
ModuleInfo "History: Improved PANEL_GROUP drawing, and a few other transparency problems."
ModuleInfo "History: Improved redraw on resize by moving LayoutKids() to WM_SIZE, and adding WS_EX_COMPOSITED."
ModuleInfo "History: Implemented hack that should hopefully fix the text-area's ghost scroll bar glitch when resizing."
ModuleInfo "History: Added fix which resizes the tabber's client when an icon strip is set."
...
ModuleInfo "History: 0.42 Release"
ModuleInfo "History: Fixed some treeview icon handling problems, and removed (now redundant) TVN_GETDISPINFO notification processing."
ModuleInfo "History: Cleaned up ToWString() calls to fix memory leaks."
ModuleInfo "History: 0.41 Release"
ModuleInfo "History: Added checks in mshtmlview.cpp to prevent text being Cut/Copied/Pasted when it shouldn't."
ModuleInfo "History: Added fix to stop black tick bands forming when using large range values on small track-bars."
ModuleInfo "History: Added a quick-hack that should greatly speed-up resizing/repositioning of gadgets, including when resizing windows."
ModuleInfo "History: Fixed a few loose-ends concerning tabber/panel WM_ERASEBKGND."
ModuleInfo "History: Fixed a few problems with WM_SIZE handling in TWindowsWindow.WndProc()."
ModuleInfo "History: Added some more constants to tom.bmx, and fixed text underlining style."
ModuleInfo "History: 0.40 Release"
ModuleInfo "History: Implemented proper GadgetPrint() support for text areas so that printing is done internally, as rich text. ;-)"
ModuleInfo "History: Fixed tree-view parent status redraw issue when the first child is added/last child is removed."
ModuleInfo "History: 0.39 Release"
ModuleInfo "History: Implemented RequestColor() proper custom-color support that saves colours between calls."
ModuleInfo "History: Fixed tool-tips - list-boxes use LVN_GETINFOTIPW, and tabbers use TTN_GETDISPINFOW."
ModuleInfo "History: Fixed XP background drawing issue on text-boxes by removing SetBkMode, and adding SetBkColor."
ModuleInfo "History: 0.38 Release"
ModuleInfo "History: Added TWindowsGUIDriver.CreateExplorerStyleGadgets()"
ModuleInfo "History: Fixed WINDOW_CLIENTCOORDS dimensions with WINDOW_MENU flag."
ModuleInfo "History: Fixed child window focus problem when maximising windows."
ModuleInfo "History: Added double-buffering support of treeviews/listboxes, as well as UseExplorerTheme() methods."
ModuleInfo "History: Added WS_CLIPSIBLINGS to text-area control."
ModuleInfo "History: 0.37 Release"
ModuleInfo "History: Added DestroyMenu() to UpdateWindowMenu() method to fix severe desktop heap memory leakage."
ModuleInfo "History: Fixed Grisu's list-box resize bug by moving LVM_SETCOLUMNWIDTH to Rethink() method."
ModuleInfo "History: Added TreeView icon support, changed Spawn() so that it is now called by the child node (tidier)."
ModuleInfo "History: Moved pixmap background drawing to WM_ERASEBKGND, and modified so that only update region is drawn."
ModuleInfo "History: Improved panel alpha support somewhat, and implemented correct handling of alpha pixmaps in SetPixmap()."
ModuleInfo "History: Fixed icon strip corruption when not using ComCtl32.dll v6 or higher (see TWindowsGUIDriver.CheckCommonControlVersion() )."
ModuleInfo "History: Moved Bitmap functions to TWindowsGraphic and added BitmapMaskFromPixmap() and PreMultipliedBitmapFromPixmap32()."
ModuleInfo "History: 0.36 Release"
ModuleInfo "History: Fixed themed button drawing problems."
ModuleInfo "History: Changed default _textcolor value to -1."
ModuleInfo "History: 0.35 Release"
ModuleInfo "History: Added ClassWndProc SetPointer fix."
ModuleInfo "History: Fixed major redraw issues with gadgets."
ModuleInfo "History: Fixed window positioning problem."
ModuleInfo "History: 0.34 Release"
ModuleInfo "History: Fixed and re-implemented client panels for tabbers/windows."
ModuleInfo "History: Tidied up colour handling code."
ModuleInfo "History: Fixed SetMinWindowSize() for WINDOW_CLIENTCOORDS."
ModuleInfo "History: Added internal method for converting Window client dimensions into container dimensions."
ModuleInfo "History: 0.33 Release"
ModuleInfo "History: Treeview nodes now handle expansion of childless parents, removed .30 cludge"
ModuleInfo "History: 0.32 Release"
ModuleInfo "History: Stopped mouse wheel events being generated on non-active panels."
ModuleInfo "History: Fixed recurring EVENT_MOUSEMOVE events."
ModuleInfo "History: Fixed panel drawing bug when changing pixmaps."
ModuleInfo "History: 0.31 Release"
ModuleInfo "History: Added menu SetText() method."
ModuleInfo "History: Improved PANEL_GROUP colour support."
ModuleInfo "History: Added LABEL_SEPARATOR support."
ModuleInfo "History: Fixed EVENT_MENUACTION so that that the menu is specified in the source."
ModuleInfo "History: Improved window behaviour slightly."
ModuleInfo "History: 0.30 Release"
ModuleInfo "History: InsertNode expands on first child to fix isparent status bug in treeviews"
ModuleInfo "History: 0.29 Release"
ModuleInfo "History: added alpha support for windows (Windows 2000 or higher only)"
ModuleInfo "History: added improved color support for windows, labels, text-fields, list-boxes and combo-boxes"
ModuleInfo "History: added GetText() method"
ModuleInfo "History: added menu hotkey text for special keys"
ModuleInfo "History: changed manifest to one without an icon"
ModuleInfo "History: 0.28 Release"
ModuleInfo "History: new native msHtmlView implementation added"
ModuleInfo "History: 0.27 Release"
ModuleInfo "History: added Seb's setstyle tweaks"
ModuleInfo "History: fixed blank readonly textareas, fixed window minimize event"
ModuleInfo "History: 0.26 Release"
ModuleInfo "History: fixed list selection width"
ModuleInfo "History: 0.25 Release"
ModuleInfo "History: fixed menu open states, faster TOM based richedit"
ModuleInfo "History: 0.24 Release"
ModuleInfo "History: fixed new tabber size, fixed onnotify filter results, optimized SetStyle"
ModuleInfo "History: 0.23 Release"
ModuleInfo "History: replaced client hwnds in windows and tabbers with setclienthandle"
ModuleInfo "History: 0.22 Release"
ModuleInfo "History: fixes for treeview/nodes including CountKids SelectedNode ModifyNode/SetText"
ModuleInfo "History: 0.21 Release"
ModuleInfo "History: fixed textfield event on settext bug"
ModuleInfo "History: 0.20 Release"
ModuleInfo "History: fixed event extra field for select and action events"
ModuleInfo "History: 0.19 Release"
ModuleInfo "History: fixed windowresize from top left messaging"
ModuleInfo "History: 0.18 Release"
ModuleInfo "History: fixed alphablend clash with max2d"
...
ModuleInfo "History: 0.16 Release"
ModuleInfo "History: fixed select treeviewnode and window clientcoord issues"
ModuleInfo "History: 0.15 Release"
ModuleInfo "History: Fixed eventextra in events, and list item selection widths"
ModuleInfo "History: 0.14 Release"
ModuleInfo "History: Fixed comboboxes and cursor repositioning with settextareatext"
ModuleInfo "History: 0.13 Release"
ModuleInfo "History: Embedded manifest and added 32bit support for toolbars"
ModuleInfo "History: 0.12 Release"
ModuleInfo "History: Fixed tabber client, autoscrollbar bug, menuevents, sliders"
ModuleInfo "History: 0.11 Release"
ModuleInfo "History: Fixed toolbar width"
ModuleInfo "History: Removed clientedge property from nonpanels"
...
'		If (style&TEXTAREA_READONLY) wstyle:|ES_READONLY						
	...
	Method SetTabs(tabs)
		Local tmpDC% = GetDC(0)
		Local tabpoints#=(tabs*720.0)/GetDeviceCaps(tmpDC,LOGPIXELSX)
		idoc.SetDefaultTabStop(tabpoints)
		ReleaseDC(0,tmpDC)
	EndMethod
